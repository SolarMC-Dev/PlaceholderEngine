...
public final class PlaceholderEngineBukkit implements LaunchablePlugin {
    ...
    public void onLaunch(Plugin plugin, Path dataFolder) {
        ...
        plugin.getServer().getOmnibus().getRegistry().register(
                PlaceholderEngine.class, RegistryPriorities.LOWEST, engine, "default Bukkit-platform engine");
    }
